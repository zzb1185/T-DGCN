...
def plot_error(train_rmse,train_loss,test_rmse,test_acc,test_mae,path):
    ...
    plt.legend(loc='best',fontsize=10)
    plt.savefig(path+'/rmse.jpg',dpi = 1000)
    ...
    plt.legend(loc='best',fontsize=10)
    plt.savefig(path+'/train_loss.jpg',dpi = 1000)
    ...
    plt.legend(loc='best',fontsize=10)
    plt.savefig(path+'/train_rmse.jpg',dpi = 1000)
    ...
    plt.legend(loc='best',fontsize=10)
    plt.savefig(path+'/test_acc.jpg',dpi = 1000)
    ...
    plt.plot(test_rmse, 'b-', label="test_rmse")
    plt.legend(loc='best',fontsize=10)
    plt.savefig(path+'/test_rmse.jpg',dpi = 1000)
    ...
    plt.legend(loc='best',fontsize=10)
    plt.savefig(path+'/test_mae.jpg',dpi = 1000)
