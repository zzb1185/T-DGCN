...
flags.DEFINE_integer('training_epoch', 1000, 'N umber of epochs to train.')
...
flags.DEFINE_string('model_name', 'tgcn', 'tgcn1')
...
data1 = data1/std_value # z-score标准化
...
plot_result(test_result,test_label1,path,pre_len)
