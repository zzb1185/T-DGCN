...
flags.DEFINE_integer('pre_len', 2, 'time length of prediction.')
flags.DEFINE_float('train_rate', 0.8, 'rate of training set.')
flags.DEFINE_integer('batch_size', 32, 'batch size.')
flags.DEFINE_string('dataset', '432',
                    'sz or los '
                    'or 533 or 1141 '
                    'or 504 or 504双链接DTW回归 '
                    'or 432. or 432_350'
                    'or 432_350_1')
flags.DEFINE_string('model_name', 'tgcn', 'tgcn or gru')
...
# data1  = (data1-mean_value)/std_value # z-score标准化
